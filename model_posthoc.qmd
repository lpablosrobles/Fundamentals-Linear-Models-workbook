...
>
> Post-hoc comparisons using Bonferroni correction showed that the estimated reading time for Condition D was significantly lower than Condition A ($t(759)=-4.42, p<.001)$, Condition B ($t(759)=-3.23,p=.001$) and Condition C ($t(759)=-3.22,p=.001$) . The larger difference was between conditions A and D ($-111.24ms,95\%CI[-160.66,-61.82]$.
