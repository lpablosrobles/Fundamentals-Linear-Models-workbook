# Introduction to tidyverse 1: data manipulation {#sec-the-r-language}
...
df <- read_csv("./data/ELP_full_length_frequency.csv")
...
durationsOnt_simplified_renamed
```
...
durationsOnt_reordered_filtered_age_gender
```
...
durationsOnt_reordered_filtered_age_gender_ordered
```
