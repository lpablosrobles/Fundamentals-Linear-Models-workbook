...
If we looked at the `lexdec_filtered` dataframe, it specifies that the variable is still a factor with two levels, but only "English" is present in the data.
