...
-   $b_1$: corresponds to the change of Condition B [with respect to the baseline condition (Condition A)]{.underline} when the other variables are 0, so the **predicted** value for Condition = B is: $626.39-26.69=599.7$
