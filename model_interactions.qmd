...
-   **InvRWRT** - Inverse Raw Reading Time
...
$$ (1/RWRT)=(2.138\times10^{-3})-(2.422\times10^{-4})\times EmbeddedSubject_{NPI}-(2.202\times10^{-4})\times AgreementMorphology_{Partitive}+(1.331\times10^{-4})\times EmbeddedSubject_{NPI}\times AgreementMorphology_{Partitive}$$
