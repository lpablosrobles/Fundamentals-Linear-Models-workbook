...
Running the `lm()` function returns a simple set of data, with the formula reflecting again and the value of the coefficients. The formula however calculates more elements. Instead, it is normally executed saving the output in a new variable.
