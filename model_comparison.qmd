...
We will look in the following sections to three other methods: model comparison i) based on F-test, ii) based on Akaike's Information Criterion (AIC) and iii) based on Bayesian Information Criterion (BIC).
