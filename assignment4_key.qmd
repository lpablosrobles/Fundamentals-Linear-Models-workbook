...
# Assignment #4 - Linear fitting with R II - Answer Key {.unnumbered}
...
For the analysis in this assignment we use again a subset of the real data from a Self-Paced Reading study on Negative Polarity Items and complementizer agreement in Basque (see Pablos, L., & Saddy, D. (2009)[@pablos2009negative]. Negative polarity items and complementizer agreement in Basque. Brain Talk, 61.)
